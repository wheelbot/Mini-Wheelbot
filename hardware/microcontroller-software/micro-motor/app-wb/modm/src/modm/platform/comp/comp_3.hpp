...
#ifndef MODM_STM32_COMP3_HPP
#define MODM_STM32_COMP3_HPP
...
namespace modm::platform
{
	 ...
	 *
	 * @internal
	 * @ingroup		modm_platform_comp modm_platform_comp_3
	 */
	class Comp3 : public CompBase
	{
	public:
		enum class
		InvertingInput
	...
	protected:
		...
		BlankingSource
		{
			...
			Tim3Oc3			= 0b010 << COMP_CSR_BLANKING_Pos,
			Tim2Oc4			= 0b011 << COMP_CSR_BLANKING_Pos,
	...
	/**
		...
		{
			COMP3->CSR = (COMP3->CSR & ~InvertingInputMask) | static_cast<uint32_t>(input);
		}
		...
		getInvertingInput()
		{
			return static_cast<InvertingInput>(COMP3->CSR & InvertingInputMask);
		}
	...
	/**
		...
		{
			COMP3->CSR = (COMP3->CSR & ~NonInvertingInputMask) | static_cast<uint32_t>(input);
		}
		...
		{
			return static_cast<NonInvertingInput>(COMP3->CSR & NonInvertingInputMask);
		}
	/**
		...
		{
			COMP3->CSR = (COMP3->CSR & ~PolarityMask) | static_cast<uint32_t>(pol);
		}
		...
		getPolarity()
		{
			return static_cast<Polarity>(COMP3->CSR & PolarityMask);
		}
		...
		{
			COMP3->CSR = (COMP3->CSR & ~HysteresisMask) | static_cast<uint32_t>(hyst);
		}
		...
		getHysteresis()
		{
			return static_cast<Hysteresis> (COMP3->CSR & HysteresisMask);
		}
		...
		{
			COMP3->CSR |= (COMP3->CSR & ~BlankingSourceMask) | static_cast<uint32_t>(blanking);
		}
		...
		getBlankingSource()
		{
			return static_cast<BlankingSource>(COMP3->CSR & BlankingSourceMask);
		}
		...
		getOutput()
		{
		return COMP3->CSR & COMP_CSR_VALUE;
		}
		...
		isLocked(void)
		{
			return COMP3->CSR & COMP_CSR_LOCK;
		}
	...
	public:
		...
		connect()
		{
			using Connector = GpioConnector<Peripheral::Comp3, Signals...>;
			Connector::connect();
		}
	};
}

#endif	//  MODM_STM32_COMP3_HPP
