...
#ifndef MODM_STM32_COMP1_HPP
#define MODM_STM32_COMP1_HPP
...
namespace modm::platform
{
	 ...
	 *
	 * @internal
	 * @ingroup		modm_platform_comp modm_platform_comp_1
	 */
	...
	/**
		...
		{
			COMP1->CSR = (COMP1->CSR & ~InvertingInputMask) | static_cast<uint32_t>(input);
		}
		...
		getInvertingInput()
		{
			return static_cast<InvertingInput>(COMP1->CSR & InvertingInputMask);
		}
	...
	/**
		...
		{
			COMP1->CSR = (COMP1->CSR & ~NonInvertingInputMask) | static_cast<uint32_t>(input);
		}
		...
		{
			return static_cast<NonInvertingInput>(COMP1->CSR & NonInvertingInputMask);
		}
	/**
		...
		{
			COMP1->CSR = (COMP1->CSR & ~PolarityMask) | static_cast<uint32_t>(pol);
		}
		...
		getPolarity()
		{
			return static_cast<Polarity>(COMP1->CSR & PolarityMask);
		}
		...
		{
			COMP1->CSR = (COMP1->CSR & ~HysteresisMask) | static_cast<uint32_t>(hyst);
		}
		...
		getHysteresis()
		{
			return static_cast<Hysteresis> (COMP1->CSR & HysteresisMask);
		}
		...
		{
			COMP1->CSR |= (COMP1->CSR & ~BlankingSourceMask) | static_cast<uint32_t>(blanking);
		}
		...
		getBlankingSource()
		{
			return static_cast<BlankingSource>(COMP1->CSR & BlankingSourceMask);
		}
		...
		isLocked(void)
		{
			return COMP1->CSR & COMP_CSR_LOCK;
		}
	...
	public:
		...
		connect()
		{
			using Connector = GpioConnector<Peripheral::Comp1, Signals...>;
			Connector::connect();
		}
	};
}

#endif	//  MODM_STM32_COMP1_HPP
